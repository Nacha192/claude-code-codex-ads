# Installing `meta-ads-team-codex-and-claude-code` for Codex
...
| Location | Scope |
|---|---|
| `<repo>/.agents/skills/meta-ads-team-codex-and-claude-code/` | this repository, and therefore the team |
| `~/.codex/skills/meta-ads-team-codex-and-claude-code/` | every project on this machine |

Unzip `INSTALL-codex-duo.zip` into one of them. The archive contains the folder,
so `meta-ads-team-codex-and-claude-code/SKILL.md` ends up at the right depth.

```bash
mkdir -p ~/.codex/skills
unzip INSTALL-codex-duo.zip -d ~/.codex/skills/
```

## `agents/openai.yaml` belongs inside the skill folder

```
.agents/skills/meta-ads-team-codex-and-claude-code/
  SKILL.md
...
```markdown
To build Meta ads, load the meta-ads-team-codex-and-claude-code skill.
```
