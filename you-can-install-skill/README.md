# The four static skills, unpacked
...
Using `meta-ads-static-codex` as the example. The other three carry the same shape.
...
| [`references/static.md`](meta-ads-static-codex/references/static.md) | images and carousels |
