# Installing `{{SKILL_NAME}}` for Claude Code
...
| Location | Scope |
|---|---|
| `<project>/.claude/skills/{{SKILL_NAME}}/` | this project only |
| `~/.claude/skills/{{SKILL_NAME}}/` | every project on this machine |
...
unzip INSTALL-{{DIST}}.zip -d ~/.claude/skills/
```
