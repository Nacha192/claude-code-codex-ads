...
### Seedance
Reported maximum around **15 seconds** [hypothesis], though a connected
catalogue exposed a 2.5 generation accepting **4 to 30 seconds** on 2026-09-06
[observed]. Take the number from the catalogue in front of you, not from here.
Described as holding stability across the full duration rather than degrading
toward the end. Its distinguishing
...
### Kling
Reported as accepting much longer clips than the others, up to minutes
[hypothesis]. A connected catalogue exposed **3 to 15 seconds** for its 3.0
generation on 2026-09-06 [observed], which is the kind of gap that turns a plan
into a reshoot. **The caveat matters more than the number**: coherence is
reported to degrade well before whatever the maximum is, with limbs drifting, backgrounds warping, and
...
- **Legible text.** Generate without it and typeset afterwards, per
  `video-assembly.md`.
